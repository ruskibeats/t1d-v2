...
export default function MealEntryScreen() {
  ...
  // Determine which legend profile is active and generate appropriate forecast
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text variant="titleLarge" style={styles.headerTitle}>Log Meal</Text>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {/* Hero Image */}
        <Image
          source={{ uri: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCZhtbEqllY2xavK8lK9E92nByrPX0SIOVUjm6DjqZfL1nZKn95HgxLkEZFyzihx4t3j4r1Eaq9L-uVI23vAIL79btexWVdAMwHGYj9rOFMHxScXKCOJ9UgJMDJITK2umTEJmCKMNC5Dmb8QJ_H71Xgsg7frvDF6FhovxcaQ74ddtNG58THaS7jwyv8BJO1ZCnGeVlWkfPnWq-BuZ9iz6MZLlkZHFq9kT2QWGHwkPgKYPsRID0TCOCnu1_KdBp-HkoReHk7GjJp7n0' }}
...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: colors.primary, fontWeight: '600' },
  ...
  heroImage: { width: '100%', height: 240, borderRadius: 16, marginBottom: spacing.sm },
  card: {
